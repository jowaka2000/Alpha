    ...
    <div class="flex w-full justify-center py-8">
        <div class="flex w-11/12 md:w-7/12 justify-between">
            ...
            <a class="border border-slate-600 hover:border-slate-400 p-2 rounded text-slate-400"
                href="{{ url()->previous()===route('deposit.mpesa',$user) || url()->previous()===route('deposit.paypal',$user) ? route('orders.index') : url()->previous() }}">
    ...
    <div class="flex w-full justify-center py-8">
        <div class="flex w-7/12 md:w-3/12 justify-center">
                ...
                <div class="w-full">
                    ...
                    <form action="{{route('deposit.paypal',$user)}}" method="POST" class="w-full py-4 space-y-3">
                        <div class="w-full flex justify-center text-green-500">
                            Deposit to your wallet using PayPal
                        </div>
                        ...
                        <div class="w-full">
                            <label for="amount" class="text-neutral-300">Deposit Amount (US $)</label>
