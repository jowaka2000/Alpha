    ...
    <div class="flex w-full justify-center py-8">
        <div class="flex w-10/12 md:w-4/12 justify-center">
            ...
            <div class="w-full">
                ...
                <form action="{{ route('unlocks-subsription.paypal', $plan) }}" method="POST" class="w-full py-4 space-y-3">
                    ...
                    <div class="w-full">
                        ...
                        <input type="number" name="amount" id="amount"
                            class="text-sm text-neutral-300  w-full bg-transparent rounded" value="{{ $amount }}"
