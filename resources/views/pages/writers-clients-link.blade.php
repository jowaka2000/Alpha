                ...
                <div class="flex items-center justify-center">
                    <img src="{{asset('images/user.png')}}" alt="" class="rounded-full w-20 h-20 b-3">
                </div>

                <div class="text-neutral-300">
                    <div class="font-semibold">Kimemia John</div>
                    <div class="mb-3">About the writer, few words</div>

                    <div class="flex items-center space-x-3 md:space-x-5">
                        <div class="flex space-x-1 items-center text-sm">
                            <span class="">8393</span>
                            <span class="uppercase">orders</span>
                        </div>

                        @if (request()->routeIs('writers') || request()->routeIs('my-writers') || request()->routeIs('blocked-writers'))
                            <div class="flex space-x-1 items-center text-sm">
                                <span class="">80%</span>
                        ...
                        @if (request()->routeIs('writers') || request()->routeIs('my-writers') || request()->routeIs('blocked-writers'))
                            <div class="hidden md:flex space-x-1 items-center text-sm">
                                <span class="">1</span>
                                <span class="uppercase">Refunds</span>
                            </div>
                        @endif

                        @if (request()->routeIs('clients') || request()->routeIs('my-clients') || request()->routeIs('blocked-clients'))
                            <div class="hidden md:flex space-x-1 items-center text-sm">
                                <span class="">100%</span>
                                <span class="uppercase">Reliable</span>
                            </div> 
                        @endif
