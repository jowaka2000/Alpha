        ...
        <div class="pt-10 w-11/12 md:w-9/12">
            <div class="flex">
                <div class="flex items-center space-x-4">
                    <a href="{{ route('completed.show',$order->completed) }}" class="border rounded border-slate-600 hover:border-slate-500 text-gray-400 font-bold p-1 hover:text-gray-300 hover:font-semibold">
...
<div class="w-full flex justify-center py-10">
    <div class="w-9/12 md:w-7/12">
        ...
        <form action="{{route('completed.edit',$order)}}" method="POST" enctype="multipart/form-data">
