...
@if (session()->has('delete_file_message'))
    <div class="w-full flex px-4  justify-center">
        <div class="w-full flex space-x-3 justify-center text-red-900 md:w-8/12 bg-red-500 py-1">
            <span>{{session('delete_file_message')}}</span>
        </div>
    </div>
@endif
        ...
        <div class="pt-10 w-11/12 md:w-9/12">
            <div class="flex">
                <div class="flex items-center space-x-4">
                    <a href="{{ route('orders.show-my-writers',$order) }}" class="border rounded border-slate-600 hover:border-slate-500 text-gray-400 font-bold p-1 hover:text-gray-300 hover:font-semibold">
