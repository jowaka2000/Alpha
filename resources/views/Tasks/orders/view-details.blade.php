...
@section('content')
            ...
            <div class="pt-10 w-11/12 md:w-10/12">
                <div class="flex justify-between">
                    <div class="flex items-center space-x-4">
                        <a href="{{ url()->previous() }}" class="border rounded border-slate-600 hover:border-slate-500 text-gray-400 font-bold p-1 hover:text-gray-300 hover:font-semibold">
                    ...
                    <a href="{{route('orders.edit',$order)}}" class="text-green-500 underline">Edit</a>
                </div>
             </div>
        </div>
    ...
    <div class="w-full bg-slate-700 flex justify-center pb-10">
        <div class="w-11/12 md:w-8/12">@include('pages.order-info')</div>
        <!--end-->
    </div>
@endsection
