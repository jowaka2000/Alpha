            ...
            <div class="pt-10 w-11/12 md:w-9/12">
                <div class="flex w-full justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <a href="{{ url()->previous() === route('writer-profile', $user) || url()->previous() === route('employer-profile.edit', $user) || url()->previous() === route('employer-profile.edit-bio', $user) ? route('orders.index') : url()->previous() }}"
                ...
                <div class="w-11/12 md:w-7/12">
                    ...
                    <div class="flex w-full justify-between py-3">
                        <div class="relative">
                            ...
                            @can('view', $user)
                                <a href="{{ route('employer-profile.edit', $user) }}">
                    ...
                    <div class="py-4 px-3 md:flex justify-between space-y-5 shadow-xl px-2 py-4">
                        ...
                        <div class="space-y-4 md:w-[50%]">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <span class="text-gray-400">{{ $user->chanel }}</span>
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-2 gap-3 text-gray-400 font-medium">
                                ...
                                <span>Raliability: </span>
                                <span
                                    class="{{ $user->reliable_rate == null ? 'opacity-50' : '' }}">{{ $user->reliable_rate == null ? 'Not Rated' : $user->reliable_rate . '%' }}</span>
                                ...
                                <div class="flex items-center">
                                    <svg aria-hidden="true"
                                        class="w-5 h-5 {{ $user->reliable_rate >= 20 ? 'text-yellow-300' : 'text-gray-400' }}"
                                    ...
                                    <svg aria-hidden="true"
                                        class="w-5 h-5 {{ $user->reliable_rate >= 40 ? 'text-yellow-300' : 'text-gray-400' }}"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <title>First star</title>
                                        <path
                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                                    ...
                                    <svg aria-hidden="true"
                                        class="w-5 h-5 {{ $user->reliable_rate >= 60 ? 'text-yellow-300' : 'text-gray-400' }}"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <title>First star</title>
                                        <path
                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                                    ...
                                    <svg aria-hidden="true"
                                        class="w-5 h-5 {{ $user->reliable_rate >= 80 ? 'text-yellow-300' : 'text-gray-400' }}"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <title>First star</title>
                                        <path
                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                                    ...
                                    <svg aria-hidden="true"
                                        class="w-5 h-5 {{ $user->reliable_rate >= 100 ? 'text-yellow-300' : 'text-gray-400' }}"
                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <title>First star</title>
                                        <path
                                            d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z">
                    ...
                    <div class="space-y-3 my-4 py-4">
                        ...
                        @cannot('view', $user)
                            <div class="text-xl text-neutral-400 font-medium underline">
                                {{ \Illuminate\Support\Str::before(strtoupper($user->name), ' ') . '\'s Bio' }}</div>
                        @endcannot

                        @can('view', $user)
                            <div class="text-xl text-neutral-400 font-bold underline">My Bio</div>
                        @endcan

                        <div class="shadow-xl px-2 py-2">
                            <div class="text-lg text-sm font-medium text-gray-400 py-3">Decription</div>
                            @if ($bio->description != null)
                                <textarea id="description" name="description" disabled rows="8"
                                    class="bg-transparent text-sm text-gray-400 block p-2.5 w-full text-sm rounded-lg dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white border-none focus-none"
                                    placeholder="Description help your writers know you better">{{ $bio->description }}</textarea>
                            @else
                                <div class="text-sm text-neutral-400 px-2">No Description yet</div>
                            @endif
                        </div>

                        <div class="shadow-xl px-2 py-2">
                            <div class="text-sm font-medium text-gray-400 py-3">Policies</div>

                            @if ($bio->policies != null)
                                <textarea id="description" name="description" disabled rows="8"
                                    class="bg-transparent text-sm text-gray-400 block p-2.5 w-full text-sm rounded-lg dark:bg-gray-700 dark:placeholder-gray-400 dark:text-white border-none focus-none"
                                    placeholder="Policies are rules that your  writers will follow to present a beter job">{{ $bio->policies }}</textarea>
                            @else
                                <div class="text-sm text-neutral-400 px-2">No Policies yet</div>
                            @endif
                        </div>
                    </div>

                    @can('view', $user)
                        <div class="w-full flex justify-end text-gray-400 pb-8">
                            <a href="{{ route('employer-profile.edit-bio', $user) }}" title="Edit My Bio"
