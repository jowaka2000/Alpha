...
@section('title','Reporting '.$user->name)

@section('content')
    @if (session()->has('report_user_message'))
                ...
                <div class="pt-10 w-11/12 md:w-10/12">
                    <div class="flex justify-between">
                        <div class="flex items-center space-x-4">
                            <a href="{{url()->previous()===route('report.index',$user) ? route('orders.index') : url()->previous()}}"
            ...
            <div>
                ...
                <div class="w-full py-5 flex justify-center">
                    <div class="w-full md:w-6/12 flex p-5">
                        <form action="{{route('report.index',$user)}}" method="POST"
