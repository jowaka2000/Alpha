...
class AccessPolicy
{
    ...
    public function unlocksSubscriptionExpired(User $user){
        return $user->access->unlock_subscription_expired;
    }

    public function ordersSubscribed(User $user){
        return $user->access->orders_subscribed;
    }
